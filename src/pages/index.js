  ...
  return (
    <div className="flex h-[100svh] justify-center items-center">
      <div className=" text-center space-y-4 ">
        <h1 className="text-4xl text-gray-500">Thank you for visiting!</h1>
        <p className="w-[500px] text-gray-400 px-4">
          Due to high traffic volume, the website is only available through your
          localhost. Please follow the instruction on README.md file to test and
          learn more about this or feel free to react out to me at <span className="text-blue-400 underline">dharmen8980@gmail.com</span>
        </p>
        <h1 className="text-xl text-slate-500">Happy Coding!</h1>
      </div>
    </div>
  );
};
